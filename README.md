...
Usage
Prerequisites: Ensure R and RStudio are installed, along with required packages (knitr, rmarkdown, dplyr, ggplot2).
Run the Script:
...
GitHub Repository: https://github.com/StevenBarden/LIS-4317-Week-12
